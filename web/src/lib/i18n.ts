...
const en: Translations = {
  ...
  health_ok: 'Source fetched {time}',
  health_stale: 'Source last fetched {time} — may be stale',
  health_never: 'Source not fetched yet',
  client_last_fetch: 'Last fetched by a client: {time} ({n}×)',
  client_never: 'Not fetched by a calendar client yet',
...
const de: Translations = {
  ...
  health_ok: 'Quelle abgerufen {time}',
  health_stale: 'Quelle zuletzt abgerufen {time} – evtl. veraltet',
  health_never: 'Quelle noch nicht abgerufen',
  client_last_fetch: 'Zuletzt von einem Client abgerufen: {time} ({n}×)',
  client_never: 'Noch von keinem Kalender-Client abgerufen',
  ...
  rule_enabled: 'Aktiv',
  remove: 'Entfernen',
  reorder_rule: 'Zum Umsortieren ziehen',
  move_up: 'Nach oben',
